...
const HeaderU = (props) => {
  return (
    <headerU data-role="Header" className="Header-header">
      <div className="Header-nav"></div>
      <Link className="Header-text1" to="/profile">{props.text1}</Link>
      <a className="Header-text2" href="/" onClick={()=>{logout()}}>{props.text11}</a>
      <Link className="Header-text3" to="/contact">{props.text111}</Link>
      ...
      <Link className="Header-text" to="/">{props.text}</Link>
    </headerU>
  )
}

HeaderU.defaultProps = {
